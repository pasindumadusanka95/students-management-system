<?php
	...
	if($_POST["delete"]) {
		$sql = "DELETE FROM modules WHERE dipid=$did";
		
		if(mysqli_query($dbconnect,$sql)) {
			echo "Deletion Successfully";
		}
		else {
			echo "Insert department ID ";
		}
...
<div class="w3-bar w3-black">
  ...
  <a href="insertdiploma.php" class="w3-bar-item w3-button">Back</a>
  
</div>

		<form action="deletediploma.php" method="post"  style="margin-left: 30px;margin-top: 20px">
		<table>
		 <caption style="margin-top: 30px;margin-bottom: 30px"><b>Diploma Information</b></caption>
		  <tr>
		    	<td>Diploma ID:</td>
		    	<td><input type="text" name="dipid" required></td>
		    </tr>
		    <tr></tr>
		     <tr></tr>
		      <tr></tr>
