...
<head>
	...
	.hdr{ width: 250px; height: 90px; float:left; text-align:center;}
	...
	.po{position:absolute;top:125px;left:140px;}
...
<body>
	...
	<div class="hdr">
	<a class="two" href="Studentdashinsert.php">Student</a>
	</div>
	<div class="hdr">
	<a class="two" href="viewmodulestddash.php">Modules</a>
	</div>
	<div class="hdr">
	<a class="two" href="viewlecturestddash.php">Lectures</a>
	</div>
	<div class="hdr">
	<a class="two" href="viewdiplomasstddash.php">Diploma</a>
	</div>
