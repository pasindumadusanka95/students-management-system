<?php
	...
	if($_POST["delete"]) {
		$sql = "DELETE FROM modules WHERE mid=$did";
		
		if(mysqli_query($dbconnect,$sql)) {
			echo "Deletion Successfully";
		}
		else {
			echo "Insert module ID ";
		}
...
<html>
  ...
  <a href="insertmodule.php" class="w3-bar-item w3-button">Back</a>
  
</div>

		<form action="deletemodule.php" method="post"  style="margin-left: 30px;margin-top: 20px">
		<table>
